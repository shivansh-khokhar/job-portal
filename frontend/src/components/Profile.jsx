    ...
    <div>
      ...
      <div className="max-w-4xl mx-auto bg-white border border-gray-200 rounded-2xl my-5 p-8">
        ...
        <div className="grid w-full max-w-sm items-center gap-1.5">
            ...
            {
                isHaveResume ? <a target="blank" href="https://google.com" className="text-blue-500 w-full hover:underline cursor-pointer">resume.pdf</a> : <span>NA</span>
            }
